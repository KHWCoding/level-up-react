...
export default function Button({ kind = 'default', ...props }: React.ButtonHTMLAttributes<HTMLButtonElement> & 
    { kind?: 'default' | 'important' | 'reference'; }) {
    return (
        <button className={ clsx('rounded-lg px-3 py-1 text-sm font-medium', {

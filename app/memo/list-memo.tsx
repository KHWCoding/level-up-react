...
export default function ListComponent({ items }: ListComponentProps) {
    ...
    return (
        <div className="p-4">
            <input type="text" value={filter} onChange={handleFilterChange} placeholder="필터 입력" className="p-2 mb-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" />
